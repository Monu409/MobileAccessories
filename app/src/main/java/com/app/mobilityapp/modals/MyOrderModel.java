...
public class MyOrderModel implements Serializable {
    ...
    @SerializedName("data")
    @Expose
    private List<MyOrderChildModel> data = null;
    ...
    public List<MyOrderChildModel> getData() {
        return data;
    }

    public void setData(List<MyOrderChildModel> data) {
        this.data = data;
    }

    public class MyOrderChildModel implements Serializable {
