...
import com.app.mobilityapp.adapter.SubCatAdapter;
...
//                ConstantMethods.dismissProgressBar();
                ...
                try {
                    ...
                    if(confirmation.equals("success")){
                        ...
                        SubCatAdapter productAdapter = new SubCatAdapter(getApplicationContext(),productsModals);
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ConstantMethods.setStringPreference("login_status","logout",SubSubCatActivity.this);
                        startActivity(new Intent(SubSubCatActivity.this,LoginActivity.class));
                    }
                });
