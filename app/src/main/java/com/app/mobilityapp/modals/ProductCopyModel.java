...
public class ProductCopyModel implements Serializable {
    ...
    @SerializedName("data")
    @Expose
    private ProductCopyChildModel data;
    ...
    public ProductCopyChildModel getData() {
        return data;
    }

    public void setData(ProductCopyChildModel data) {
        this.data = data;
    }
    ...
    public class ProductCopyChildModel implements Serializable {
        ...
        @Expose
        private List<Object> colour = null;
        @SerializedName("status")
        @Expose
        private Boolean status;
